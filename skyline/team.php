      ...
      <h3>We are Purdue Industrial Engineering Students here to provide optimized dynamic sensor network solutions over multiple geographic regions</h3><br>
        ...
        <div class="column">
          <div class="card" style="width: 20rem;style="height: 15rem;>
            <img src="images/1.png" width="150" height="150" alt="Manuel" class="pfp" style="margin-left:75px" style="width:100%">
        ...
        <div class="column">
          <div class="card"style="width: 20rem;style="height: 15rem;>
            <img src="images/2.jpg" width="150" height="150" alt="Marcus" class="pfp" style="margin-left:75px">
            <div class="container" style="margin-left:20px">
        ...
        <div class="column">
          <div class="card" style="width: 20rem;style="height: 15rem;>
            <img src="images/3.png" width="150" height="150" alt="Nihar" class="pfp" style="margin-left:75px">
            <div class="container" style="margin-left:20px">
        ...
        <div class="column">
          <div class="card" style="width: 20rem;style="height: 15rem;>
            <img src="images/4.jpeg" width="150" height="150" alt="Jiani"  class="pfp" style="margin-left:75px">
            <div class="container" style="margin-left:20px">
        ...
        <div class="column">
          <div class="card" style="width: 20rem; style="height: 15rem;>
          <img src="images/6.jpeg" width="150px" height="150" alt="Rohan" class="pfp" style="margin-left:75px">
            <div class="container" style="margin-left:20px">
        ...
        <div class="column">
            <div class="card" style="width: 20rem;style="height: 15rem;>
              <img src="images/7.jpeg" width="150" height="150" alt="Julianna" class="pfp" style="margin-left:75px">
              <div class="container" style="margin-left:20px">
		    ...
		    <div class="column">
          <div class="card" style="width: 20rem;style="height: 15rem;>
            <img src="images/5.jpeg" width="150" height="150" alt="Spoorthi" class="pfp" style="margin-left:75px">
            <div class="container" style="margin-left:20px">
